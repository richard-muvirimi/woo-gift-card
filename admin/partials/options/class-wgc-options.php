...
class Woo_gift_card_Options
{
	...
	public function add_settings_section()
	{
		add_settings_section(
			'wgc-customise-section',
			__('General Options', 'woo-gift-card'),
			array($this, 'print_general_options_section'),
			'wgc-customise'
		);

		add_settings_section(
			'wgc-generation-section',
			__('Gift Voucher Generation', 'woo-gift-card'),
			array($this, 'print_generation_options_section'),
			'wgc-generation'
		);

		add_settings_section(
			'wgc-email-section',
			__('Gift Voucher Email Options', 'woo-gift-card'),
			array($this, 'print_email_options_section'),
			'wgc-email'
		);
	}
	...
	public function do_customise_options()
	{
		...
		add_settings_field(
			'wgc-list-shop',
			__('Gift Vouchers in shop', 'woo-gift-card'),
			array($this, 'output_list_vouchers_field'),
			'wgc-customise',
			'wgc-customise-section',
			array('label_for' => 'wgc-list-shop')
		);
	}
	...
	public function do_generation_options()
	{
		add_settings_field(
			'wgc-code-length',
			__('Gift Voucher length', 'woo-gift-card'),
			array($this, 'output_code_length_field'),
			'wgc-generation',
			'wgc-generation-section',
			array('label_for' => 'wgc-code-length')
		);

		add_settings_field(
			'wgc-code-special',
			__('Gift Voucher special characters', 'woo-gift-card'),
			array($this, 'output_code_special_field'),
			'wgc-generation',
			'wgc-generation-section',
			array('label_for' => 'wgc-code-special')
		);

		add_settings_field(
			'wgc-code-prefix',
			__('Gift Voucher prefix', 'woo-gift-card'),
			array($this, 'output_code_prefix_field'),
			'wgc-generation',
			'wgc-generation-section',
			array('label_for' => 'wgc-code-prefix')
		);

		add_settings_field(
			'wgc-code-suffix',
			__('Gift Voucher suffix', 'woo-gift-card'),
			array($this, 'output_code_suffix_field'),
			'wgc-generation',
			'wgc-generation-section',
			array('label_for' => 'wgc-code-suffix')
		);
	}
	...
	public function do_email_options()
	{
		add_settings_field(
			'wgc-message-length',
			__('Gift Voucher message length', 'woo-gift-card'),
			array($this, 'output_message_length_field'),
			'wgc-email',
			'wgc-email-section',
			array('label_for' => 'wgc-message-length')
		);

		add_settings_field(
			'wgc-message-disclaimer',
			__('Gift Voucher message disclaimer', 'woo-gift-card'),
			array($this, 'output_message_disclaimer_field'),
			'wgc-email',
			'wgc-email-section',
			array('label_for' => 'wgc-message-disclaimer')
		);
	}
